...
assert(verificationPlanText.includes("Desktop > Command Prompt > netstat -an") && verificationPlanText.includes("Desktop > Command Prompt > netstat -ano") && verificationPlanText.includes("Desktop > Command Prompt > netstat -abno") && verificationPlanText.includes("Desktop > Command Prompt > tasklist /svc") && verificationPlanText.includes("Desktop > Command Prompt > nslookup <record> [dns-server]") && verificationPlanText.includes("Desktop netstat shows expected listening service ports") && verificationPlanText.includes("Desktop netstat -ano shows listener PID evidence") && verificationPlanText.includes("Desktop netstat -abno shows listener process names") && verificationPlanText.includes("Desktop tasklist /svc maps listener PIDs to service process names") && verificationPlanText.includes("show services summary") && verificationPlanText.includes("show service logs summary") && verificationPlanText.includes("show ip dhcp pool summary") && verificationPlanText.includes("show ip dhcp binding summary") && verificationPlanText.includes("show hosts summary") && verificationPlanText.includes("show service logs dns") && verificationPlanText.includes("show service logs http"), "verification plan text must include service-specific Desktop, directed DNS, service, and log checks for service devices");
...
assert(instructorWorkbookText.includes("netsh interface ip show config") && instructorWorkbookText.includes("Desktop Command Prompt netstat -an, netstat -ano, or netstat -abno plus tasklist /svc") && instructorWorkbookText.includes("PID evidence") && instructorWorkbookText.includes("process names") && instructorWorkbookText.includes("nslookup <record> <dns-server>") && instructorWorkbookText.includes("show services summary") && instructorWorkbookText.includes("show ip dhcp pool summary") && instructorWorkbookText.includes("show ip dhcp binding summary") && instructorWorkbookText.includes("show hosts summary") && instructorWorkbookText.includes("show service logs dns") && instructorWorkbookText.includes("show service logs summary"), "lab workbook must recommend Desktop netsh, listener/PID/process, directed DNS, service, DHCP, DNS, and log summary checks");
