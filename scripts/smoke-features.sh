...
const { clearDesktopArpEntries, desktopArpTable, desktopDnsCache, desktopGetDnsClientServerAddress, desktopGetmacTable, desktopGetNetAdapter, desktopGetNetIpConfiguration, desktopGetNetNeighbor, desktopGetNetRoute, desktopGetNetTcpConnection, desktopGetProcess, desktopHostname, desktopIpconfigAll, desktopNetshInterfaceConfig, desktopNetstatListening, desktopNetstatListeningRows, desktopResolveDnsNameOutput, desktopRoutePrint, desktopScQuery, desktopTasklist, isDesktopNetshInterfaceConfigCommand, isDesktopRoutePrintCommand, parseDesktopArpCommand, parseDesktopGetDnsClientServerAddressCommand, parseDesktopGetNetAdapterCommand, parseDesktopGetNetIpConfigurationCommand, parseDesktopGetNetNeighborCommand, parseDesktopGetNetRouteCommand, parseDesktopGetNetTcpConnectionCommand, parseDesktopGetProcessCommand, parseDesktopNetstatCommand, parseDesktopNslookupCommand, parseDesktopPingCommand, parseDesktopRemoteAccessCommand, parseDesktopResolveDnsNameCommand, parseDesktopScCommand, parseDesktopTasklistCommand, parseDesktopTestNetConnectionCommand, parseDesktopTraceCommand } = require(path.join(tmpdir, "engine/desktopDiagnostics.js"));
