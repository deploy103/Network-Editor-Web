...
assert(instructorWorkbookText.includes("netsh interface ip show config") && instructorWorkbookText.includes("Desktop Command Prompt netstat -an or netstat -ano") && instructorWorkbookText.includes("PID evidence") && instructorWorkbookText.includes("nslookup <record> <dns-server>") && instructorWorkbookText.includes("show services summary") && instructorWorkbookText.includes("show ip dhcp pool summary") && instructorWorkbookText.includes("show ip dhcp binding summary") && instructorWorkbookText.includes("show hosts summary") && instructorWorkbookText.includes("show service logs dns") && instructorWorkbookText.includes("show service logs summary"), "lab workbook must recommend Desktop netsh, listener/PID, directed DNS, service, DHCP, DNS, and log summary checks");
