...
const { clearDesktopArpEntries, desktopArpTable, desktopGetmacTable, desktopHostname, desktopIpconfigAll, desktopNetstatListening, desktopNetstatListeningRows, desktopRoutePrint, parseDesktopNslookupCommand, parseDesktopPingCommand, parseDesktopTraceCommand } = require(path.join(tmpdir, "engine/desktopDiagnostics.js"));
...
assert(verificationPlanText.includes("Verify desktop identity") && verificationPlanText.includes("Desktop > Command Prompt > getmac") && verificationPlanText.includes("Desktop > Command Prompt > getmac /v") && verificationPlanText.includes("Desktop > Command Prompt > route print") && verificationPlanText.includes("Desktop > Command Prompt > route print -4"), "verification plan text must include Desktop identity and adapter evidence checks");
assert(verificationPlanText.includes("Desktop > Command Prompt > netstat -an") && verificationPlanText.includes("Desktop > Command Prompt > netstat -ano") && verificationPlanText.includes("Desktop > Command Prompt > nslookup <record> [dns-server]") && verificationPlanText.includes("Desktop netstat shows expected listening service ports") && verificationPlanText.includes("Desktop netstat -ano shows listener PID evidence") && verificationPlanText.includes("show services summary") && verificationPlanText.includes("show service logs summary") && verificationPlanText.includes("show ip dhcp pool summary") && verificationPlanText.includes("show ip dhcp binding summary") && verificationPlanText.includes("show hosts summary") && verificationPlanText.includes("show service logs dns") && verificationPlanText.includes("show service logs http"), "verification plan text must include service-specific Desktop, directed DNS, service, and log checks for service devices");
...
assert(instructorWorkbookText.includes("Desktop Command Prompt netstat -an or netstat -ano") && instructorWorkbookText.includes("PID evidence") && instructorWorkbookText.includes("nslookup <record> <dns-server>") && instructorWorkbookText.includes("show services summary") && instructorWorkbookText.includes("show ip dhcp pool summary") && instructorWorkbookText.includes("show ip dhcp binding summary") && instructorWorkbookText.includes("show hosts summary") && instructorWorkbookText.includes("show service logs dns") && instructorWorkbookText.includes("show service logs summary"), "lab workbook must recommend Desktop listener/PID, directed DNS, service, DHCP, DNS, and log summary checks");
