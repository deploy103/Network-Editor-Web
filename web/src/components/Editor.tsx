    ...
    <section className="desktop-panel">
      ...
      {activeApp === "prompt" && (
        <section className="terminal desktop-terminal">
          ...
          <small>프로젝트 장비 {project.devices.length}개 | hostname, getmac, ipconfig, netsh, arp -a, arp -d, route print, netstat, tasklist, ping, tracert, pathping, nslookup, http, ftp, email, ssh, telnet, tftp, syslog</small>
        </section>
      )}
      {activeApp === "browser" && (
