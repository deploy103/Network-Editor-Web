...
function serviceSection(project: NetworkProject): WorkbookSection {
  ...
  return {
    ...
    lines: [
      ...
      "- Use Desktop Command Prompt netstat -an, netstat -ano, or netstat -abno plus tasklist /svc and sc queryex <service> on service devices to confirm listening application ports, PID evidence, process names, and service state.",
