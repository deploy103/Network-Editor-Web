...
function serviceVerificationCommands(device: NetworkDevice): string[] {
  const commands = ["Desktop > Services", "Desktop > Command Prompt > netstat -an", "Desktop > Command Prompt > netstat -ano", "Desktop > Command Prompt > netstat -abno", "Desktop > Command Prompt > tasklist /svc", "Desktop > Command Prompt > sc queryex <service>", "show services", "show services summary", "show service logs", "show service logs summary"];
...
function serviceVerificationExpected(device: NetworkDevice): string[] {
  ...
  if (expected.length) expected.push("Desktop netstat shows expected listening service ports", "Desktop netstat -ano shows listener PID evidence", "Desktop netstat -abno shows listener process names", "Desktop tasklist /svc maps listener PIDs to service process names", "Desktop sc queryex shows service state and PID evidence");
