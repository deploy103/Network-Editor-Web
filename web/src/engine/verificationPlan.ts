...
function serviceVerificationCommands(device: NetworkDevice): string[] {
  const commands = ["Desktop > Services", "Desktop > Command Prompt > Test-NetConnection <server> -Port <port>", "Desktop > Command Prompt > netstat -an", "Desktop > Command Prompt > netstat -ano", "Desktop > Command Prompt > netstat -abno", "Desktop > Command Prompt > tasklist /svc", "Desktop > Command Prompt > sc queryex <service>", "show services", "show services summary", "show service logs", "show service logs summary"];
